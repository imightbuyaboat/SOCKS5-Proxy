...
document.getElementById("saveBtn").onclick = async () => {
  ...
  let body = {
    socks5_server_address: document.getElementById("socks5_server_address").value,
    ...
    allow_no_auth: document.getElementById("allow_no_auth").checked,
  };
  ...
  if (res.ok) {
    ...
    if (res.data.current_config) {
      ...
      document.getElementById("socks5_server_address").value = res.data.current_config.socks5_server_address;
      ...
      document.getElementById("allow_no_auth").checked = res.data.current_config.allow_no_auth;
    }
  }
};
